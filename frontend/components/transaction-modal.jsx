...
export function TransactionModal({ open, onOpenChange, action, amount, onConfirm }) {
    ...
    return (<Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="glass-card sm:max-w-md border-border">
        ...
        <div className="py-6">
          {state === 'pending' && (<div className="flex flex-col gap-6">
              <div className="glass rounded-xl p-4 space-y-3">
                <div className="flex justify-between text-sm">
                  <span className="text-muted-foreground">Action</span>
                  <span className="text-foreground font-medium">{action}</span>
                </div>
                {amount !== undefined && (<div className="flex justify-between text-sm">
          ...
          {state === 'confirming' && (<div className="flex flex-col items-center gap-4 py-8">
          ...
          {state === 'success' && txHash && (<div className="flex flex-col items-center gap-4 py-4">
              ...
              <div className="glass rounded-xl p-4 w-full">
                <div className="flex justify-between items-center text-sm">
                  ...
                  <a href={`https://sepolia.etherscan.io/tx/${txHash}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 text-primary hover:underline">
                    {truncateHash(txHash)}
          ...
          {state === 'error' && (<div className="flex flex-col items-center gap-4 py-4">
