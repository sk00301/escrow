...
import { Coins, TrendingUp, Lock, Unlock, Gift, ArrowUpRight, Clock, CheckCircle } from "lucide-react";
...
export function JuryRewards() {
    ...
    return (<div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <StatsCard title="Total Earned" value={totalRewards} suffix=" JURY" icon={TrendingUp} trend={{ value: 8, positive: true }}/>
        <StatsCard title="Pending Rewards" value={pendingRewards} suffix=" JURY" icon={Gift}/>
        <StatsCard title="Staked Amount" value={stakedAmount} suffix=" JURY" icon={Lock}/>
        <StatsCard title="Claimed" value={claimedRewards} suffix=" JURY" icon={CheckCircle}/>
      </div>

      {/* Claim Rewards Card */}
      {pendingRewards > 0 && (<Card className="border-primary/50 bg-primary/5">
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            {rewardHistory.map((reward) => (<div key={reward.id} className="flex items-center justify-between rounded-lg border border-border p-4">
        ...
        <DialogContent>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input id="stake-amount" type="number" placeholder="0" value={stakeAmount} onChange={(e) => setStakeAmount(e.target.value)} className="mt-2"/>
            </div>
        ...
        <DialogContent>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input id="unstake-amount" type="number" placeholder="0" value={stakeAmount} onChange={(e) => setStakeAmount(e.target.value)} className="mt-2"/>
            </div>
