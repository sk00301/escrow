...
import { Scale, CheckCircle, Clock, Coins, TrendingUp, AlertCircle, ArrowRight } from "lucide-react";
export function JuryOverview() {
    ...
    return (<div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <StatsCard title="Voting Accuracy" value={accuracy} suffix="%" icon={TrendingUp} trend={{ value: 5, positive: true }}/>
        <StatsCard title="JURY Staked" value={userProfile?.juryStake ?? 0} icon={Coins}/>
      </div>
      ...
      {pendingDisputes.length > 0 && (<Card>
          ...
          <CardContent>
            <div className="space-y-4">
              {pendingDisputes.slice(0, 3).map((dispute) => (<div key={dispute.id} className="flex items-center justify-between rounded-lg border border-border p-4">
