...
type StatusFilter = 'all' | 'funded' | 'submitted' | 'verified' | 'disputed' | 'released'
    ...
    <div className="space-y-8">
      ...
      {filteredContracts.length === 0 ? (
        <EmptyState
          ...
          description="You don't have any contracts matching this filter yet."
        />
      ) : (
                          ...
                          <div className="glass rounded-lg p-3">
                            ...
                            <div className="w-full bg-muted rounded-full h-2">
                              <div 
                                ...
                                style={{ width: `${contract.acceptanceCriteria.testPassRate}%` }}
                              />
                            </div>
                          </div>
                        </div>
