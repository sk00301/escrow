...
import { Clock, DollarSign, FileText, Upload, CheckCircle, AlertCircle } from "lucide-react"
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
export function ActiveContracts() {
  ...
  const activeContracts = contracts.filter(
    (c) => c.freelancerAddress === walletAddress && ["funded", "submitted", "verified"].includes(c.status)
  )
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="rounded-lg border border-border bg-muted/30 p-4">
                      ...
                      <ul className="mt-2 space-y-2">
                        {contract.acceptanceCriteria.requirements.map((req, index) => (
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-lg border border-border bg-muted/50 p-4">
              ...
              <ul className="mt-2 space-y-1">
                {selectedContract?.acceptanceCriteria.requirements.map((req, index) => (
