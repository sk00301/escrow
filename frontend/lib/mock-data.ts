...
export const mockDisputes = MOCK_DISPUTES.map(d => ({
  ...
  votes: d.votesFor > 0 ? [
    { jurorAddress: '0x5678901234AbCdEf5678901234aBcDeF56789012', vote: 'client' as const, reasoning: 'Evidence supports client', timestamp: new Date() },
    { jurorAddress: '0x1234567890AbCdEf1234567890aBcDeF12345678', vote: 'freelancer' as const, reasoning: 'Work was completed', timestamp: new Date() },
  ] : [],
  evidence: [
    { submittedBy: 'client' as const, type: 'text', description: d.evidence.clientEvidence, url: null, timestamp: d.createdAt },
    { submittedBy: 'freelancer' as const, type: 'text', description: d.evidence.freelancerEvidence || 'No evidence submitted', url: null, timestamp: d.createdAt },
  ],
