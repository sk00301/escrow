...
import { LayoutDashboard, FilePlus, FileText, AlertTriangle } from 'lucide-react';
...
function ClientDashboardContent() {
  ...
  useEffect(() => {
    if (!requestedTab) router.replace('/client?tab=overview');
  }, [requestedTab, router]);
    ...
    <RoleGuard requiredRole="client">
      <div className="min-h-screen bg-background">
        ...
        <div className="flex pt-16">
          <DashboardSidebar links={sidebarLinks} role="client" basePath="/client" />
