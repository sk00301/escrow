            ...
            <div className={`rounded-2xl border p-6 mb-6 ${verdictBg}`}>
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex items-center gap-4">
                  {result.verdict === 'approved' ? (
                    <CheckCircle className="h-10 w-10 text-[#10B981] shrink-0" />
                  ) : result.verdict === 'rejected' ? (
                    <XCircle className="h-10 w-10 text-[#EF4444] shrink-0" />
                  ) : (
                  ...
                  <div key={key}>
                    <div className="flex items-center justify-between mb-1.5">
                      ...
                      <span className={`text-sm font-semibold ${
                        (value as number) >= 85 ? 'text-[#10B981]' :
                        (value as number) >= 65 ? 'text-[#F59E0B]' : 'text-[#EF4444]'
                      }`}>
                        {value as number}%
                      </span>
                    </div>
            ...
            <div className="glass-card rounded-2xl border border-border p-6 mb-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 rounded-lg border border-border bg-muted/30 px-4 py-3">
                  ...
                  <a
                    href={`https://ipfs.io/ipfs/${result.ipfsLink.replace('ipfs://', '')}`}
                    target="_blank"
