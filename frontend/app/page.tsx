          ...
          <div className="animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              {isConnected ? (
                ...
                <Button 
                  size="lg" 
                  className="bg-primary text-primary-foreground hover:bg-primary/90 cyan-glow gap-2 px-8 h-14 text-lg"
              ...
              <Button 
                size="lg" 
                variant="outline" 
                className="border-border bg-muted/30 hover:bg-muted/50 gap-2 px-8 h-14 text-lg"
              >
                Learn More
              </Button>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div 
                key={feature.title}
                className="glass-card rounded-2xl p-8 border border-border hover:border-primary/50 transition-all duration-300 hover:-translate-y-1 group"
